...
export class ReportsService {
  ...
  getDailyCollectionReport(officeID :any, date: any):Observable<any>{
    let httpParams = new HttpParams()
        .set('officeId', officeID)
        .set('date', date);
    return this.http.get('/chitgroup/reports/dailycollection',{ params : httpParams})
  }
  getNonStartedGroupReport(officeID :any, date: any):Observable<any>{
    let httpParams = new HttpParams()
        .set('officeId', officeID)
        .set('date', date);
    return this.http.get('/chitgroup/reports/nonstartedgroup',{ params : httpParams})
  }
  getPSBucketReport(officeID :any, date: any):Observable<any>{
    let httpParams = new HttpParams()
        .set('officeId', officeID)
        .set('date', date);
    return this.http.get('/chitgroup/reports/psbucketreport',{ params : httpParams})
  }
  getNPSBucketWiseReport(officeID :any, date: any):Observable<any>{
    let httpParams = new HttpParams()
        .set('officeId', officeID)
        .set('date', date);
    return this.http.get('/chitgroup/reports/npsbucketreport',{ params : httpParams})
  }
}
