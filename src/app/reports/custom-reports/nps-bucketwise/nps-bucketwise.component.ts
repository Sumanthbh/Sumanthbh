...
@Component({
  selector: 'mifosx-nps-bucketwise',
  templateUrl: './nps-bucketwise.component.html',
  styleUrls: ['./nps-bucketwise.component.scss']
})
export class NpsBucketwiseComponent implements OnInit {
   ...
   getReportData(){
     this.reportService.getNPSBucketWiseReport(this.childOfficeIdValue,this.childReportDateValue ).subscribe((response: any)=>{
       this.reportData = response['Non-Prized Subscribers'];
