...
export class ClientApprovalComponent {
  ...
  approveClients() {
    const formfields: FormfieldBase[] = [
      new CheckboxBase({
        controlName: 'verifCB1',
        label: 'Aadhar Verified',
       required: true
      }),
      new CheckboxBase({
       controlName: 'verifCB2',
       label: 'Secondary Proof Verified',
       required: true
      }),
      new CheckboxBase({
       controlName: 'verifCB3',
       label: 'Credit Score Verified',
       required: true
      }),
      new DatepickerBase({
        controlName: 'actDate',
    ...
    const data = {
      title: 'Enter Clients Approval Date',
