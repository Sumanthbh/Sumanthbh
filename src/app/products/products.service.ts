...
export class ProductsService {
  ...
  /**
   * @returns {Observable<any>} Branch Specific Configuration
   */
  createBranchSpecificConfig(branchSpecific: string): Observable<any>{
    return this.http.post('/branchesAccount',branchSpecific);
  }

  getConfiguredBranches(): Observable<any>{
    return this.http.get('/branchesAccount');
  }

  getConfiguredBranche(id: string, template: boolean= false): Observable<any>{
    const httpParams = new HttpParams().set('template', template.toString());
    return this.http.get(`/branchesAccount/${id}`, {params: httpParams});
  }
  
  getCashDetails(): Observable<any>{
    return this.http.get('/branchesAccount/cashDetails');
  }

  getBankDetails(): Observable<any>{
    return this.http.get('/branchesAccount/bankDetails');
  }

  updateBranchConfig(branchId : string, branchConfig: any): Observable<any>{
    return this.http.put(`/branchesAccount/${branchId}`, branchConfig);
  }

  /**
   * @returns {Observable<any>} Chit Charge Configuration
   */

   getChitCharges(): Observable<any> {
    return this.http.get('/chitcharge');
  }

  getChitCharge(id: any): Observable<any>{
    return this.http.get(`/chitcharge/${id}`)
  }

  /**
   * @returns {Observable<any>} Chit Products Configuration
   */

  getChitProduct(id: any): Observable<any>{
    console.log("hi");
    
    return this.http.get(`/NsChitGroup/${id}`)
  }

  getChitProducts(): Observable<any> {
    return this.http.get('/NsChitGroup');
  }

  /**
   * @param {any} chitproduct Product to be created.
   * @returns {Observable<any>}
   */
   createChitProductConfig(chitproduct: any): Observable<any>{
    return this.http.post('/NsChitGroup',chitproduct);
  }

  /**
   * @param chitproductId Charge Id to be updated.
   * @param chitproduct  Charge Data to be updated.
   * @returns {Observable<any>} charge.
   */

   editChitProductConfig(chitproductId: string, chitproduct: any): Observable<any>{
    return this.http.put(`/NsChitGroup/${chitproductId}`,chitproduct);
  }

   /**
   * @param {string} chitproductId Chit Product ID of Product to be deleted.
   * @returns {Observable<any>}
   */

  deleteChitProduct(chitproductId: string): Observable<any> {
    return this.http.delete(`/NsChitGroup/${chitproductId}`);
  }  
  

  /**
   * @param {any} chitcharge Charge to be created.
   * @returns {Observable<any>}
   */
  createChitChargeConfig(chitcharge: any): Observable<any>{
    return this.http.post('/chitcharge',chitcharge);
  }

  /**
   * @param chitchargeId Charge Id to be updated.
   * @param chitcharge  Charge Data to be updated.
   * @returns {Observable<any>} charge.
   */

  editChitChargeConfig(chitchargeId: string, chitcharge: any): Observable<any>{
    return this.http.put(`/chitcharge/${chitchargeId}`,chitcharge);
  }

   /**
   * @param {string} chitchargeId Chit Charge ID of Charge to be deleted.
   * @returns {Observable<any>}
   */

  deleteChitCharge(chitchargeId: string): Observable<any> {
    return this.http.delete(`/chitcharge/${chitchargeId}`);
  }  
