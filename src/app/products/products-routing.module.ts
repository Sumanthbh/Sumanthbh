...
import {ChitProductAccountingComponent} from './chit-products/chit-product-accounting.component';
import {ChitAccoutingTemplateResolver} from './chit-products/chit-accounting-template.resolver';
import { ChitAccoutingMappingResolver } from './chit-products/chit-accounting-mapping.resolver';
import {BranchSpecificAccountingConfigComponent} from './branch-specific-accounting-config/branch-specific-accounting-config.component';
import {CreateConfigComponent} from './branch-specific-accounting-config/create-config/create-config.component';
import { BranchResolver } from './branch-specific-accounting-config/branchReslover/branch.resolver';
import {EditConfigComponent} from './branch-specific-accounting-config/edit-config/edit-config.component';
import {OfficeResolver} from './branch-specific-accounting-config/branchReslover/office.resolver';
import {CashResolver} from './branch-specific-accounting-config/branchReslover/cash.resolver';
import {BankResolver} from './branch-specific-accounting-config/branchReslover/bank.resolver';
import { SingleConfigBranch } from './branch-specific-accounting-config/branchReslover/singleConfigBranch.resolver';
import {ChitChargeConfigComponent} from './chit-charges-configuration/chit-charge-config.component';
import {ChitCreateConfigComponent} from './chit-charges-configuration/create-config/create-charge.component';
import { ChitEditConfigComponent } from './chit-charges-configuration/edit-config/edit-config.component'; 
import {ChitChargesResolver} from './chit-charges-configuration/chit-charges.resolver';
import { ChitViewConfigComponent } from './chit-charges-configuration/view-config/view-config.component';
import { ChitChargeResolver } from './chit-charges-configuration/chit-charge.resolver';
import { ChitProductsConfigurationComponent } from './chit-products-configuration/chit-products-configuration.component';
import { ChitCreateProductComponent } from './chit-products-configuration/create-config/create-product.component';
import { ChitViewProductComponent } from './chit-products-configuration/view-config/view-product.component';
import { ChitEditProductComponent } from './chit-products-configuration/edit-config/edit-product.component';
import { ChitProductResolver } from './chit-products-configuration/chit-product.resolver';
import { ChitProductsResolver } from './chit-products-configuration/chit-products.resolver';
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: '',
              data: { title: extract('Chit Accounting Configuration'), breadcrumb: 'Configuration' },
              component: ChitProductAccountingComponent,
              resolve: {
                chitAccoutingTemplate: ChitAccoutingTemplateResolver,
                chitAccGLMapping: ChitAccoutingMappingResolver
              }
            }
          ]
        },  
        {
          path: 'branch-specific-accounting-config',
          data: { title: extract('Branch Configuration'), breadcrumb: 'Branch Configuration' },
          children: [
            {
              path: '',
              component: BranchSpecificAccountingConfigComponent,
              resolve:{
                office : OfficeResolver,
                configuredBranches : BranchResolver,
                cash: CashResolver,
                bank: BankResolver,
              }
            },
            {
              path: 'create',
              data: { title: extract('Create Branch Configuration'), breadcrumb: 'Create Branch Configuration' },
            ...
            },
            {
              ...
              children: [
                {
                  path: 'edit',
                  data: { title: extract('Edit Branch Configuration'), breadcrumb: 'Edit'},
                  component: EditConfigComponent,
                  resolve: {
                  office : OfficeResolver,
                  singleBranch: SingleConfigBranch,
                  cash: CashResolver,
                  bank: BankResolver,
                  }
                }
        ...
        {
          path: 'chit-products-config',
          data: { title: extract('Chit Products Configuration'), breadcrumb: 'Chit Products Configuration' },
          children: [
            {
              path: '',
              component: ChitProductsConfigurationComponent,
              resolve: {
            ...
            {
              path: 'create',
              data: {title: extract('Chit Product Configuration'), breadcrumb: 'Chit Product Configuration'},
              component: ChitCreateProductComponent,
            },
            {
              path: ':id',
              data: { title: extract('View Product'), routeParamBreadcrumb: 'id' },
              children: [
                {
                  path: '',
                  component: ChitViewProductComponent,
                  resolve: {
                    product: ChitProductResolver
                  }
                },
                {
                  path: 'edit',
                  component: ChitEditProductComponent,
                  data: { title: extract('Edit Product'), breadcrumb: 'Edit', routeResolveBreadcrumb: false },
                  resolve: {
                    product: ChitProductResolver
                  }
                }
        ...
        {
          path: 'chit-charges',
          data: { title: extract('Chit Charge Configuration'), breadcrumb: 'Chit Charge Configuration' },
          children: [
            {
              path: '',
              component: ChitChargeConfigComponent,
              resolve:{
                charges: ChitChargesResolver
                
              }
            },
            {
              path: 'create',
              data: { title: extract('Create Charge Configuration'), breadcrumb: 'Create Charge Configuration' },
              component : ChitCreateConfigComponent,
          },
          {
            path: ':id',
            data: { title: extract('View Charge'), routeParamBreadcrumb: 'id' },
            children: [
              {
                path: '',
                component: ChitViewConfigComponent,
                resolve: {
                  charge: ChitChargeResolver
                }
              },
              {
                path: 'edit',
                component: ChitEditConfigComponent,
                data: { title: extract('Edit Charge'), breadcrumb: 'Edit', routeResolveBreadcrumb: false },
                resolve: {
                  charge: ChitChargeResolver
                }
              }
...
@NgModule({
  ...
  providers: [
    ...
    FloatingRatesResolver,
    ChitProductAccountingComponent,
    ChitAccoutingTemplateResolver,
    ChitAccoutingMappingResolver,
    BranchResolver,
    EditConfigComponent,
    OfficeResolver,
    CashResolver,
    BankResolver,
    SingleConfigBranch,
    ChitChargeConfigComponent,
    ChitCreateConfigComponent,
    // ChitEditConfigComponent,
    ChitChargesResolver,
    ChitViewConfigComponent,
    ChitChargeResolver,
