...
export class ClientsDataSource implements DataSource<any> {
   ...
   */
  // getClients(filterBy: any,orderBy: string = '', sortOrder: string = '', pageIndex: number = 0, limit: number = 10, clientActive: boolean = true) {
  ...
  getClients(filterBy: any, orderBy: string = '', sortOrder: string = '', pageIndex: number = 0, limit: number = 10) {
    this.clientsSubject.next([]);
    this.clientsService.getClients(filterBy, orderBy, sortOrder, pageIndex * limit, limit)
      .subscribe((clients: any) => {
   ...
   * @param {number} limit Number of clients within the page.
   */
  // filterClients(filters:any,filter: string, orderBy: string = '', sortOrder: string = '', pageIndex: number = 0, limit: number = 10, clientActive: boolean = true) {
  //   this.clientsSubject.next([]);
  //   this.clientsService.getClients(orderBy, sortOrder, pageIndex * limit, limit)
  //     .subscribe((clients: any) => {
