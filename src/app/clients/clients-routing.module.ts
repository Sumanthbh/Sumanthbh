...
import { Guarantors } from './common-resolvers/guarantors.resolver';
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path:'guarantor',
            data: { title: extract('Guarantor'), breadcrumb: 'Guarantor', routeParamBreadcrumb: false },
            children:[
              {
                path:'',
                component: GuarantorTabComponent,
                resolve:{
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: 'fin-details',
            component: EditClientFinDetailsComponent,
            data: { title: extract('fin-details'), breadcrumb: 'Financial Details', routeParamBreadcrumb: false},
            resolve: {
              clientDataAndTemplate: ClientDataAndTemplateResolver
            }
          },
          ...
          //   component: EditClientNomineeStepComponent,
          //   data: { title: extract('nominee-details'), breadcrumb: 'Nominee-Details', routeParamBreadcrumb: false},
          //   resolve: {
          //     clientDataAndTemplate: ClientDataAndTemplateResolver
          //   }
          // },
