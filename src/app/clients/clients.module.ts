...
import { PayChitAdvanceComponent } from './clients-view/client-actions/pay-chit-advance/pay-chit-advance.component';
...
import { EditClientFinDetailsComponent } from './clients-view/fin-detail-tab/fin-detail-tab.component';
...
import { CibilCheckComponent} from './clients-view/client-actions/cibil-check/cibil-check.component';
import { PayChitChargeComponent } from './clients-view/client-actions/pay-chit-charge/pay-chit-charge.component';
import { GuarantorTabComponent } from './clients-view/guarantor-tab/guarantor-tab.component';
import { AddGuarantorComponent } from './clients-view/guarantor-tab/add-guarantor/add-guarantor.component';
// import { EditGuarantorComponent } from './clients-view/guarantor-tab/edit-guarantor/edit-guarantor.component';
// import { ClientNomineeStepComponent } from './client-stepper/client-nominee-step/client-nominee-step.component';
// import { EditClientNomineeStepComponent } from './clients-view/nominee-tab/nominee-tab.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ClientFinDetailStepComponent,
    EditClientFinDetailsComponent,
    CaptureImageDialogComponent,
    CreateSelfServiceUserComponent,
    CibilCheckComponent,
    PayChitChargeComponent,
    GuarantorTabComponent,
    AddGuarantorComponent,
    // EditGuarantorComponent,
    // ClientNomineeStepComponent,
    // EditClientNomineeStepComponent,
  ],
